...
flowchart TD
    ...
    C --> D[Excel Spreadsheet<br/>Estimation]
    D --> E[Create Word Document<br/>Proposal]
    E --> F[Email Proposal<br/>to Customer]
    F --> G{Customer Response}
    G -->|Email Accept| H[Verbal/Email<br/>Confirmation]
    G -->|Supply Pro| I[Supply Pro<br/>Submission]
    H --> J[Manual Invoice<br/>Creation]
    I --> J
    J --> K[Manual P.O.<br/>Matching]
    K --> L[Job Scheduling<br/>Manual Process]
    
    classDef painPoint fill:#ffcccc,stroke:#ff0000,stroke-width:2px
```
